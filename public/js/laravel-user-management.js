  ...
  \*************************************************/
    ...
    $(function () {
      ...
      var dt_user_table = $('.datatables-users'),
        select2 = $('.select2'),
        userView = baseUrl + 'users/view/account',
      ...
      $(document).on('click', '.delete-record', function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
              type: 'DELETE',
              url: ''.concat(baseUrl, 'users/users-list/').concat(user_id),
      ...
      $(document).on('click', '.edit-record', function () {
        ...
        // get data
        $.get(''.concat(baseUrl, 'users/users-list/').concat(user_id, '/edit'), function (data) {
          $('#user_id').val(data.id);
      ...
      var fv = FormValidation.formValidation(addNewUserForm, {
        ...
        $.ajax({
          ...
          url: ''.concat(baseUrl, 'users/users-list'),
          type: 'POST',
