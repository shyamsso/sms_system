  ...
  \*************************************************/
    ...
    $(function () {
      ...
      var dt_user_table = $('.datatables-users'),
        ...
        clientApi = baseUrl + 'sms_key',
        client_number = baseUrl + 'client_number',
      ...
      if (dt_user_table.length) {
        var dt_user = dt_user_table.DataTable({
          ...
          serverSide: true,
          ajax: {
            url: baseUrl + 'client/client-list'
          },
          columns: [
            ...
            },
            {
              ...
              render: function render(data, type, full, meta) {
                return (
                  ...
                  '/' +
                  full['id'] +
                  '" class="dropdown-item">Client Api Key</a>' +
                  '<a href="' +
                  client_number +
                  '?id=' +
                  full['id'] +
                  '" class="dropdown-item">Client Number</a>' +
                  '</div>' +
                  '</div>'
                );
              }
          ...
          buttons: [
            ...
            {
              text: '<i class="bx bx-plus me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add New Client</span>',
      ...
      $(document).on('click', '.delete-record', function () {
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
              type: 'DELETE',
              url: ''.concat(baseUrl, 'client/client-list/').concat(user_id),
      ...
      $(document).on('click', '.edit-record', function () {
        ...
        // get data
        $.get(''.concat(baseUrl, 'client/client-list/').concat(user_id, '/edit'), function (data) {
          $('#user_id').val(data.id);
      ...
      var fv = FormValidation.formValidation(addNewUserForm, {
        ...
        $.ajax({
          ...
          url: ''.concat(baseUrl, 'client/client-list'),
          type: 'POST',
