...
class ClientController extends Controller
{
  ...
  public function UserManagement()
  {
    ...
    $users = User::where('roles', 'Client')
      ...
      ->get();
    $userCount = User::where('roles', 'Client')->count();
    $verified = User::whereNotNull('email_verified_at')
      ->get()
      ->count();
    $notVerified = User::where('roles', 'Client')
  ...
  public function index(Request $request)
  {
    ...
    $totalData = User::where('roles', 'Client')->count();
  ...
  public function store(Request $request)
  {
    ...
    if ($userID) {
      ...
      if (empty($userEmail)) {
        ...
        Mail::to($request->email)->send(new ClientEmail($data));
        //$userrolle = [$request->userrole];
        //$users->assignRole($userrolle);
        // user created
