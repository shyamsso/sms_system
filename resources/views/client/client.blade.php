...
@section('page-script')
<script src="{{asset('js/laravel-client-management.js')}}"></script>
@endsection
      ...
      <form class="add-new-user pt-0" id="addNewUserForm">
        ...
        <div class="mb-3">
          ...
          <select id="country" name="country" class="form-select">
            ...
            <option value="{{ $list->name }}">{{ $list->nicename }}</option>
            @endforeach
          </select>
        </div>
        <div class="mb-3">
          <label class="form-label" for="smscommission">SMS Commission</label>
          <input type="text" id="smscommission" class="form-control" placeholder="" aria-label="" name="smscommission" />
        </div>
